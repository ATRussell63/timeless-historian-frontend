...
export const ALL_RARITY_ANCHORS = [ENGLISH_ANCHOR, FRENCH_ANCHOR, GERMAN_ANCHOR, PORTUGESE_ANCHOR, RUSSIAN_ANCHOR, SPANISH_ANCHOR, THAI_ANCHOR, KOREAN_ANCHOR]
export const ALL_JEWEL_NAMES = [...ENGLISH_JEWEL_NAMES, ...FRENCH_NAMES, ...GERMAN_NAMES, ...PORTUGESE_NAMES, ...RUSSIAN_NAMES, ...SPANISH_NAMES, ...THAI_NAMES, ...KOREAN_NAMES]


export function map_jewel_name_to_english(jewel_name) {
    const LANGUAGES = [FRENCH_NAMES, GERMAN_NAMES, PORTUGESE_NAMES, RUSSIAN_NAMES, SPANISH_NAMES, KOREAN_NAMES]
